...
main() {
  ...
  void _createTreeMap(String host, int mode) {
    ...
    node.enter.append("div")
      ...
      ..styleWithCallback(
          'width', (d, i, e) => '${max(0, (d.dx as int) - 1)}px')
      ..styleWithCallback(
          'height', (d, i, e) => '${max(0, (d.dy as int) - 1)}px')
      ..styleWithCallback(
          'background',
          (d, i, e) => (d as TreeMapNode).children.isNotEmpty
              ? theme.getColorForKey(d.label, ChartTheme.STATE_NORMAL)
              : null)
      ..textWithCallback((d, i, e) =>
          ((d as TreeMapNode).children.isNotEmpty ? null : d.label).toString())
      ..classed('node');
  }
